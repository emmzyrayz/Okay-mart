...
<!-- molla/elements-titles.html  22 Nov 2019 10:05:01 GMT -->
<head>
    <meta charset="UTF-8">
    ...
    <div class="page-wrapper">
        ...
        <main class="main">
        	<div class="page-header text-center" style="background-image: url('assets/images/page-header-bg.jpg')">
        		<div class="container">
        			<h1 class="page-title">Titles<span>Elements</span></h1>
        		</div><!-- End .container -->
        	</div><!-- End .page-header -->
            ...
            <div class="page-content">
                <div class="container">
                    <h2 class="title">Simple title</h2><!-- End .title -->
                    <p>Sed egestas, ante et vulputate volutpat, eros pede semper est, vitae luctus metus libero eu augue. Morbi purus libero, faucibus adipiscing, commodo quis, gravida id, est. Sed lectus. Praesent elementum hendrerit tortor. Sed semper lorem at felis. Vestibulum volutpat, lacus a ultrices sagittis, mi neque euismod dui, eu pulvinar nunc sapien ornare nisl. Phasellus pede arcu, dapibus eu, fermentum et, dapibus sed, urna.</p>

                    <hr class="mt-4 mb-4">

                    <div class="heading">
                        <h2 class="title">Simple title <span class="title-separator">/</span> Subtitle</h2><!-- End .title -->
                        <p class="title-desc">Donec consectetuer ligula vulputate sem tristique cursus. </p><!-- End .title-desc -->
                    </div><!-- End .heading -->
                    <p>Sed egestas, ante et vulputate volutpat, eros pede semper est, vitae luctus metus libero eu augue. Morbi purus libero, faucibus adipiscing, commodo quis, gravida id, est. Sed lectus. Praesent elementum hendrerit tortor. Sed semper lorem at felis. Vestibulum volutpat, lacus a ultrices sagittis, mi neque euismod dui, eu pulvinar nunc sapien ornare nisl. Phasellus pede arcu, dapibus eu, fermentum et, dapibus sed, urna.</p>
                    ...
                    <div class="heading heading-flex">
                        <div class="heading-left">
                            <h2 class="title">Simple title <span class="title-separator">/</span> Product Filter</h2><!-- End .title -->
                    ...
                    <div class="heading heading-flex align-items-start">
                        <div class="heading-left">
                            <h2 class="title">Simple title <span class="title-separator">/</span> Subtitle <span class="title-separator">/</span> Product Filter</h2><!-- End .title -->
                            <p class="title-desc">Donec consectetuer ligula vulputate sem tristique cursus. </p><!-- End .title-desc -->
                        </div><!-- End .heading-left -->
                    ...
                    <div class="heading heading-flex">
                        <div class="heading-left">
                            <h2 class="title">Simple title <span class="title-separator">/</span> Link</h2><!-- End .title -->
                        </div><!-- End .heading-left -->

                        <div class="heading-right">
                            <a href="#" class="title-link">Click here to view <i class="icon-long-arrow-right"></i></a>
                        </div><!-- End .heading-right -->
                    </div><!-- End .heading -->
                    <p>Sed egestas, ante et vulputate volutpat, eros pede semper est, vitae luctus metus libero eu augue. Morbi purus libero, faucibus adipiscing, commodo quis, gravida id, est. Sed lectus. Praesent elementum hendrerit tortor. Sed semper lorem at felis. Vestibulum volutpat, lacus a ultrices sagittis, mi neque euismod dui, eu pulvinar nunc sapien ornare nisl. Phasellus pede arcu, dapibus eu, fermentum et, dapibus sed, urna.</p>
                    ...
                    <div class="heading heading-flex">
                        <div class="heading-left">
                            <h2 class="title">Simple title <span class="title-separator">/</span> Substitle <span class="title-separator">/</span> Link</h2><!-- End .title -->
                            <p class="title-desc">Donec consectetuer ligula vulputate sem tristique cursus. </p><!-- End .title-desc -->
                        </div><!-- End .heading-left -->

                        <div class="heading-right">
                            <a href="#" class="title-link link-underline">Click here to view <i class="icon-long-arrow-right"></i></a>
                        </div><!-- End .heading-right -->
                    </div><!-- End .heading -->
                    <p>Sed egestas, ante et vulputate volutpat, eros pede semper est, vitae luctus metus libero eu augue. Morbi purus libero, faucibus adipiscing, commodo quis, gravida id, est. Sed lectus. Praesent elementum hendrerit tortor. Sed semper lorem at felis. Vestibulum volutpat, lacus a ultrices sagittis, mi neque euismod dui, eu pulvinar nunc sapien ornare nisl. Phasellus pede arcu, dapibus eu, fermentum et, dapibus sed, urna.</p>
                    ...
                    <div class="text-center">
                        <h2 class="title">Centered title</h2><!-- End .title -->
                        <p>Sed egestas, ante et vulputate volutpat, eros pede semper est, vitae luctus metus libero eu augue. Morbi purus libero, faucibus adipiscing, commodo quis, gravida id, est. Sed lectus. Praesent elementum hendrerit tortor. Sed semper lorem at felis. Vestibulum volutpat, lacus a ultrices sagittis, mi neque euismod dui, eu pulvinar nunc sapien ornare nisl. Phasellus pede arcu, dapibus eu, fermentum et, dapibus sed, urna.</p>
                    </div><!-- End .text-center -->
                    ...
                    <div class="heading heading-center">
                        <div class="heading-left">
                            <h2 class="title">Centered title <span class="title-separator">/</span> Product Filter</h2><!-- End .title -->
                        </div><!-- End .heading-left -->
                    ...
                    <p class="text-center">Sed egestas, ante et vulputate volutpat, eros pede semper est, vitae luctus metus libero eu augue. Morbi purus libero, faucibus adipiscing, commodo quis, gravida id, est. Sed lectus. Praesent elementum hendrerit tortor. Sed semper lorem at felis. Vestibulum volutpat, lacus a ultrices sagittis, mi neque euismod dui, eu pulvinar nunc sapien ornare nisl. Phasellus pede arcu, dapibus eu, fermentum et, dapibus sed, urna.</p>

                    <hr class="mt-4 mb-4">

                    <h2 class="title-sm">Small Title</h2><!-- End .title -->
                    <p>Sed egestas, ante et vulputate volutpat, eros pede semper est, vitae luctus metus libero eu augue. Morbi purus libero, faucibus adipiscing, commodo quis, gravida id, est. Sed lectus. Praesent elementum hendrerit tortor. Sed semper lorem at felis. Vestibulum volutpat, lacus a ultrices sagittis, mi neque euismod dui, eu pulvinar nunc sapien ornare nisl. Phasellus pede arcu, dapibus eu, fermentum et, dapibus sed, urna.</p>

                    <hr class="mt-4 mb-4">

                    <div class="heading">
                        <p class="title-desc mb-1">Quisque a lectus.</p><!-- End .title-desc -->
                        <h2 class="title-sm">Small title <span class="title-separator">/</span> Subtitle</h2><!-- End .title -->
                    </div><!-- End .heading -->
                    <p>Sed egestas, ante et vulputate volutpat, eros pede semper est, vitae luctus metus libero eu augue. Morbi purus libero, faucibus adipiscing, commodo quis, gravida id, est. Sed lectus. Praesent elementum hendrerit tortor. Sed semper lorem at felis. Vestibulum volutpat, lacus a ultrices sagittis, mi neque euismod dui, eu pulvinar nunc sapien ornare nisl. Phasellus pede arcu, dapibus eu, fermentum et, dapibus sed, urna.</p>
                    ...
                    <div class="text-center">
                        <h2 class="title-sm">Centered Small Title</h2><!-- End .title -->
                        <p>Sed egestas, ante et vulputate volutpat, eros pede semper est, vitae luctus metus libero eu augue. Morbi purus libero, faucibus adipiscing, commodo quis, gravida id, est. Sed lectus. Praesent elementum hendrerit tortor. Sed semper lorem at felis. Vestibulum volutpat, lacus a ultrices sagittis, mi neque euismod dui, eu pulvinar nunc sapien ornare nisl. Phasellus pede arcu, dapibus eu, fermentum et, dapibus sed, urna.</p>
                    </div><!-- End .text-center -->
                    ...
                    <div class="heading text-center">
                        <p class="title-desc mb-1">Quisque a lectus.</p><!-- End .title-desc -->
                        <h2 class="title-sm">Centered Small title <span class="title-separator">/</span> Subtitle</h2><!-- End .title -->
                    </div><!-- End .heading -->
                    <p class="text-center">Sed egestas, ante et vulputate volutpat, eros pede semper est, vitae luctus metus libero eu augue. Morbi purus libero, faucibus adipiscing, commodo quis, gravida id, est. Sed lectus. Praesent elementum hendrerit tortor. Sed semper lorem at felis. Vestibulum volutpat, lacus a ultrices sagittis, mi neque euismod dui, eu pulvinar nunc sapien ornare nisl. Phasellus pede arcu, dapibus eu, fermentum et, dapibus sed, urna.</p>
                </div><!-- End .container -->
