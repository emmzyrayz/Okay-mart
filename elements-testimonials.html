...
<!-- molla/elements-testimonials.html  22 Nov 2019 10:05:18 GMT -->
<head>
    <meta charset="UTF-8">
    ...
    <div class="page-wrapper">
        ...
        <main class="main">
        	<div class="page-header text-center" style="background-image: url('assets/images/page-header-bg.jpg')">
        		<div class="container">
        			<h1 class="page-title">Testimonials<span>Elements</span></h1>
        		</div><!-- End .container -->
        	</div><!-- End .page-header -->
            ...
            <div class="page-content">
                <div class="container">
                	<h2 class="title text-center mb-3">Quote Sign <span class="title-separator">/</span> Centered Align</h2><!-- End .title text-center -->
                	...
                	<hr class="mt-5 mb-5">
                	<h2 class="title text-center mb-3">Quote Sign <span class="title-separator">/</span> Centered Align <span class="title-separator">/</span> 2 Columns</h2><!-- End .title text-center -->
                	...
                	<hr class="mt-5 mb-5">
                	<h2 class="title text-center mb-3">Quote Sign <span class="title-separator">/</span> Centered Align <span class="title-separator">/</span> 3 Columns</h2><!-- End .title text-center -->
            	...
            	<div class="bg-image bg-overlay pt-5 pb-4" style="background-image: url(assets/images/backgrounds/bg-1.jpg)">
            		<div class="container">
            			<h2 class="title text-center text-white mb-3">Quote Sign <span class="title-separator">/</span> Centered Align <span class="title-separator">/</span> Dark Background</h2><!-- End .title text-center -->
                ...
                <div class="container">
                	<h2 class="title text-center mb-3">Customer Photo <span class="title-separator">/</span> Centered Align</h2><!-- End .title text-center -->
                	...
                	<hr class="mt-5 mb-5">
                	<h2 class="title text-center mb-3">Customer Photo <span class="title-separator">/</span> Centered Align <span class="title-separator">/</span> 2 Columns</h2><!-- End .title text-center -->
