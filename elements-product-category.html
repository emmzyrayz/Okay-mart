        ...
        <main class="main">
            ...
            <div class="page-content">
                <div class="container">
                	...
                	<h2 class="title text-center mb-3">3 Columns Badge Style</h2><!-- End .title mb-2 -->
                	...
                	<h2 class="title text-center mb-3">4 Columns Carousel</h2><!-- End .title mb-2 -->
				...
				<div class="container">
                	...
                	<h2 class="title text-center mb-3">Masonry</h2><!-- End .title mb-2 -->
                	...
                	<h2 class="title text-center mb-3">Grid Badge Style</h2><!-- End .title mb-2 -->
