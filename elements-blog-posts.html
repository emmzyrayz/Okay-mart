    ...
    <div class="page-wrapper">
        ...
        <main class="main">
        	<div class="page-header text-center" style="background-image: url('assets/images/page-header-bg.jpg')">
        		<div class="container">
        			<h1 class="page-title">Blog Posts<span>Elements</span></h1>
        		</div><!-- End .container -->
        	</div><!-- End .page-header -->
            ...
            <div class="page-content">
                <div class="container">
                	...
                	<h2 class="title text-center mb-2">Classic</h2><!-- End .title text-center -->
                	...
                	<h2 class="title text-center mb-2">Grid 2 Columns</h2><!-- End .title text-center -->
                	...
                	<h2 class="title text-center mb-2">Grid 3 Columns</h2><!-- End .title text-center -->
                	...
                	<h2 class="title text-center mb-2">Grid 4 Columns</h2><!-- End .title text-center -->
                	<div class="row justify-content-center">
                		...
                		<div class="col-sm-6 col-lg-3">
                			<article class="entry entry-grid">
                				...
                				<div class="entry-body text-center">
                					...
                					<div class="entry-content">
                						<p>Sed egestas, ante et vulputate volutpat, eros pede semper est, vitae luctus metus libero ...</p> <a href="single.html" class="read-more">Read More</a>
                					</div><!-- End .entry-content -->
                				</div><!-- End .entry-body -->
                			</article><!-- End .entry -->
                		</div><!-- End .col-lg-3 -->
                	...
                	<h2 class="title text-center mb-2">Grid 3 Columns <span class="title-separator">/</span> Mask</h2><!-- End .title text-center -->
                	<div class="row justify-content-center">
                		<div class="col-sm-6 col-md-4">
