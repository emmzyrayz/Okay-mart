    ...
    <div class="page-wrapper">
        ...
        <main class="main">
        	<div class="page-header text-center" style="background-image: url('assets/images/page-header-bg.jpg')">
        		<div class="container">
        			<h1 class="page-title">Icon Boxes<span>Elements</span></h1>
        		</div><!-- End .container -->
        	</div><!-- End .page-header -->
            <nav aria-label="breadcrumb" class="breadcrumb-nav">
                <div class="container">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Icon Boxes</li>
                    </ol>
                </div><!-- End .container -->
            ...
            <div class="page-content">
                <div class="container">
                    <h2 class="title mb-4 text-center">Simple Icons <span class="title-separator">/</span> Centered Align <span class="title-separator">/</span> 3 Columns</h2><!-- End .title text-center -->
                    <div class="row justify-content-center">
                        <div class="col-lg-4 col-sm-6">
                            <div class="icon-box text-center">
                                ...
                                <div class="icon-box-content">
                                    <h3 class="icon-box-title">Quisque a lectus</h3><!-- End .icon-box-title -->
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="icon-box text-center">
                                ...
                                <div class="icon-box-content">
                                    <h3 class="icon-box-title">Suspendisse potenti</h3><!-- End .icon-box-title -->
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="icon-box text-center">
                                ...
                                <div class="icon-box-content">
                                    <h3 class="icon-box-title">Phasellus hendrerit</h3><!-- End .icon-box-title -->
                    ...
                    <h2 class="title mb-5 text-center">Simple Icons <span class="title-separator">/</span> Left Align <span class="title-separator">/</span> 3 Columns</h2><!-- End .title text-center -->
                    <div class="row justify-content-center">
                        <div class="col-lg-4 col-sm-6">
                    ...
                    <h2 class="title mb-4 text-center">Circle Icons <span class="title-separator">/</span> Centered Align <span class="title-separator">/</span> 3 Columns</h2><!-- End .title text-center -->
                    <div class="row justify-content-center">
                        <div class="col-lg-4 col-sm-6">
                    ...
                    <h2 class="title mb-5 text-center">Circle Icons <span class="title-separator">/</span> Left Align <span class="title-separator">/</span> 3 Columns</h2><!-- End .title text-center -->
                    <div class="row justify-content-center">
                        <div class="col-lg-4 col-sm-6">
                    ...
                    <h2 class="title mb-4 text-center">Simple Icons <span class="title-separator">/</span> Centered Align <span class="title-separator">/</span> 4 Columns</h2><!-- End .title text-center -->
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="icon-box text-center">
                                ...
                                <div class="icon-box-content">
                                    <h3 class="icon-box-title">Fusce pellentesque</h3><!-- End .icon-box-title -->
                    ...
                    <h2 class="title mb-5 text-center">Simple Icons <span class="title-separator">/</span> Left Align <span class="title-separator">/</span> 4 Columns</h2><!-- End .title text-center -->
                    <div class="row justify-content-center">
                        <div class="col-lg-3 col-sm-6">
                            <div class="icon-box icon-box-left">
                                <span class="icon-box-icon">
                    ...
                    <h2 class="title mb-4 text-center">Circle Icons <span class="title-separator">/</span> Centered Align <span class="title-separator">/</span> 4 Columns</h2><!-- End .title text-center -->
                    <div class="row justify-content-center">
                        <div class="col-lg-3 col-sm-6">
                            <div class="icon-box icon-box-circle text-center">
                                <span class="icon-box-icon">
