...
<!-- molla/elements-cta.html  22 Nov 2019 10:05:32 GMT -->
<head>
    <meta charset="UTF-8">
    ...
    <div class="page-wrapper">
        ...
        <main class="main">
            ...
            <div class="page-content pb-0">
                <div class="container">
                	<h2 class="title text-center mb-5">Newsletter Banner <span class="title-separator">/</span> With Background</h2><!-- End .title -->
                    ...
                    <hr class="mb-5">
                    <h2 class="title text-center mb-5">Newsletter Banner <span class="title-separator">/</span> With Dark Background</h2><!-- End .title -->
                </div><!-- End .container -->
                ...
                <div class="container">
	                <h2 class="title text-center mb-5">Newsletter Banner <span class="title-separator">/</span> Without Background</h2><!-- End .title -->
                	...
                	<h2 class="title text-center mb-5">Call to Action <span class="title-separator">/</span> Newsletter Banner <span class="title-separator">/</span> With Background</h2><!-- End .title -->
	                ...
	                <h2 class="title text-center mb-5">Call to Action <span class="title-separator">/</span> Newsletter Banner <span class="title-separator">/</span> No Background</h2><!-- End .title -->
                	...
                	<div class="row">
                		<div class="col-lg-6">
			                <div class="cta bg-image mb-3" style="background-image: url(assets/images/backgrounds/cta/bg-3.jpg);background-position: center right;">
		            			<div class="cta-wrapper cta-text text-center">
		            				<h3 class="cta-title">Morbi in sem quis dui placerat pellentesque felis.</h3><!-- End .cta-title -->
			            			<p class="cta-desc">Donec nec justo eget felis facilisis fermentum. Aliquam porttitor mauris sit amet orci. </p><!-- End .cta-desc -->
                		...
                		<div class="col-lg-6">
			                <div class="cta bg-image mb-3" style="background-image: url(assets/images/backgrounds/cta/bg-4.jpg);background-position: center right;">
		            			<div class="cta-wrapper text-center">
		            				<h3 class="cta-title">Join Our Newsletter</h3><!-- End .cta-title -->
			            			<p class="cta-desc">Lorem ipsum dolor sit amet adipiscing.</p><!-- End .cta-desc -->
				...
				<div class="container">
	                <h2 class="title text-center mb-5">Sale Banner  <span class="title-separator">/</span> With Background</h2><!-- End .title -->
							...
							<div class="col-md-11 col-xl-10">
								<div class="cta-content">
									<div class="cta-heading">
										<h3 class="cta-title text-right">Vivamus vestibulum <br>ntulla nec ante</h3><!-- End .cta-title -->
									</div><!-- End .cta-heading -->
	                ...
	                <hr class="mb-5">
                    <h2 class="title text-center mb-5">Sale Banner  <span class="title-separator">/</span> With Dark Background</h2><!-- End .title -->
                </div><!-- End .container -->

                <div class="cta bg-image bg-dark pt-6 pb-7" style="background-image: url(assets/images/backgrounds/bg-1.jpg);">
            		<div class="container">
            			<div class="row justify-content-center">
		            		<div class="col-sm-10 col-md-8 col-lg-6">
		            			<div class="cta-text text-center">
		            				<h3 class="cta-title text-white">Morbi in sem quis dui placerat felis.</h3><!-- End .cta-title -->
			            			<p class="cta-desc text-light">Morbi in sem quis dui placerat ornare. Pellentesque odio nisi, euismod in, pharetra a, ultricies in, diam. Sed arcu. Cras consequat.</p><!-- End .cta-desc -->
...
<!-- molla/elements-cta.html  22 Nov 2019 10:05:34 GMT -->
</html>