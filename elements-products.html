                    ...
                    <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl" 
            			...
            			<div class="product">
            				...
            				<div class="product-body product-action-inner">
            					...
            					<div class="ratings-container">
            						<div class="ratings">
            							<div class="ratings-val ratings-primary" style="width: 0%;"></div><!-- End .ratings-val -->
            						</div><!-- End .ratings -->
                    ...
                    <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow product-4-carousel" data-toggle="owl" 
                        ...
                        <div class="product product-4 text-center">
                            <figure class="product-media">
                                ...
                                <a href="product.html">
                                    <img src="assets/images/products/elements/5cols/product-1.jpg" alt="Product image" class="product-image">
                                </a>
                        ...
                        <div class="product product-4 text-center product-disabled">
                            <figure class="product-media">
                                <a href="product.html">
                                    <img src="assets/images/products/elements/5cols/product-2.jpg" alt="Product image" class="product-image">
                                </a>
                        ...
                        <div class="product product-4 text-center">
                            <figure class="product-media">
                                <span class="product-label label-circle label-sale">Sale</span>
                                <a href="product.html">
                                    <img src="assets/images/products/elements/5cols/product-3.jpg" alt="Product image" class="product-image">
                                </a>
                                
                                <div class="product-countdown-container">
                                    <span class="product-contdown-title">offer ends in:</span>
                                    <div class="product-countdown countdown-compact" data-until="2019, 10, 5" data-compact="true"></div><!-- End .product-countdown -->
                        ...
                        <div class="product product-4 text-center">
                            <figure class="product-media">
                                <a href="product.html">
                                    <img src="assets/images/products/elements/5cols/product-4.jpg" alt="Product image" class="product-image">
                                </a>
                        ...
                        <div class="product product-4 text-center">
                            <figure class="product-media">
                                <span class="product-label label-circle label-new">New</span>
                                <a href="product.html">
                                    <img src="assets/images/products/elements/5cols/product-5.jpg" alt="Product image" class="product-image">
                                </a>
                            ...
                            <div class="product-body">
                                <h3 class="product-title"><a href="product.html">Vivamus vestibulum</a></h3><!-- End .product-title -->
                                <div class="product-price">
                                    $110.00
                                </div><!-- End .product-price -->
                                <div class="product-nav product-nav-dots">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 col-md-4 col-lg-3 col-xl-2">
                            <div class="product product-5 text-center">
                                <figure class="product-media">
                                    <span class="product-label label-new">New</span>
                                    <a href="product.html">
                                        <img src="assets/images/products/elements/product-5.jpg" alt="Product image" class="product-image">
                                    </a>
                        ...
                        <div class="col-6 col-md-4 col-lg-3 col-xl-2">
                            <div class="product product-5 text-center">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="assets/images/products/elements/product-6.jpg" alt="Product image" class="product-image">
                                    </a>
