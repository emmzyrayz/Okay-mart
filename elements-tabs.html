    ...
    <div class="page-wrapper">
        ...
        <main class="main">
        	<div class="page-header text-center" style="background-image: url('assets/images/page-header-bg.jpg')">
        		<div class="container">
        			<h1 class="page-title">Tabs<span>Elements</span></h1>
        		</div><!-- End .container -->
        	</div><!-- End .page-header -->
            ...
            <div class="page-content">
                <div class="container">
                	<div class="row">
                		<div class="col-12">
                			<h2 class="title mb-3">Left Align Style</h2><!-- End .title mb-3 -->
                		</div><!-- End .col-12 -->
                		<div class="col-md-6">
	            			<ul class="nav nav-tabs nav-tabs-bg" id="tabs-1" role="tablist">
							    ...
							    <li class="nav-item">
							        <a class="nav-link" id="tab-4-tab" data-toggle="tab" href="#tab-4" role="tab" aria-controls="tab-4" aria-selected="false">Tab 4</a>
							    </li>
							</ul>
                		...
                		<div class="col-md-6">
	            			<ul class="nav nav-tabs" id="tabs-2" role="tablist">
							    ...
							    <li class="nav-item">
							        <a class="nav-link" id="tab-7-tab" data-toggle="tab" href="#tab-7" role="tab" aria-controls="tab-7" aria-selected="false">Tab 3</a>
							    </li>
							    <li class="nav-item">
                	...
                	<div class="row">
                		<div class="col-12">
                			<h2 class="title mb-3">Centered Align Style</h2><!-- End .title mb-3 -->
                		</div><!-- End .col-12 -->
                		<div class="col-md-6">
	            			<ul class="nav nav-tabs nav-tabs-bg justify-content-center" id="tabs-3" role="tablist">
							    ...
							    <li class="nav-item">
							        <a class="nav-link" id="tab-11-tab" data-toggle="tab" href="#tab-11" role="tab" aria-controls="tab-11" aria-selected="false">Tab 3</a>
							    </li>
							    <li class="nav-item">
							        <a class="nav-link" id="tab-12-tab" data-toggle="tab" href="#tab-12" role="tab" aria-controls="tab-12" aria-selected="false">Tab 4</a>
							    </li>
							</ul>
                		...
                		<div class="col-md-6">
	            			<ul class="nav nav-tabs justify-content-center" id="tabs-4" role="tablist">
							    ...
							    <li class="nav-item">
							        <a class="nav-link" id="tab-15-tab" data-toggle="tab" href="#tab-15" role="tab" aria-controls="tab-15" aria-selected="false">Tab 3</a>
							    </li>
							    <li class="nav-item">
							        <a class="nav-link" id="tab-16-tab" data-toggle="tab" href="#tab-16" role="tab" aria-controls="tab-16" aria-selected="false">Tab 4</a>
							    </li>
							</ul>
					...
					<div class="row">
                		<div class="col-12">
                			<h2 class="title mb-3">Line Style Tabs</h2><!-- End .title mb-3 -->
                		</div><!-- End .col-12 -->
                		<div class="col-md-6">
	            			<ul class="nav nav-pills" id="tabs-5" role="tablist">
							    ...
							    <li class="nav-item">
							        <a class="nav-link" id="tab-19-tab" data-toggle="tab" href="#tab-19" role="tab" aria-controls="tab-19" aria-selected="false">Tab 3</a>
							    </li>
							    <li class="nav-item">
							        <a class="nav-link" id="tab-20-tab" data-toggle="tab" href="#tab-20" role="tab" aria-controls="tab-20" aria-selected="false">Tab 4</a>
							    </li>
							</ul>
                	...
                	<div class="row">
                		<div class="col-12">
                			<h2 class="title mb-3">Vertical Style</h2><!-- End .title mb-3 -->
                		</div><!-- End .col-12 -->
                		<div class="col-md-6">
                			<div class="tabs-vertical">
		            			<ul class="nav nav-tabs nav-tabs-bg flex-column" id="tabs-7" role="tablist">
								    ...
								    <li class="nav-item">
								        <a class="nav-link" id="tab-27-tab" data-toggle="tab" href="#tab-27" role="tab" aria-controls="tab-27" aria-selected="false">Tab 3</a>
								    </li>
								    <li class="nav-item">
								        <a class="nav-link" id="tab-28-tab" data-toggle="tab" href="#tab-28" role="tab" aria-controls="tab-28" aria-selected="false">Tab 4</a>
								    </li>
								</ul>
